...
const course = {
  ...
  description: 'Hands-on introduction to supervised and unsupervised learning, model evaluation, and practical ML workflows.',
  tags: ['advanced', 'featured'],
  image: 'https://images.unsplash.com/photo-1555949963-aa79dcee981c?w=1200&h=800&auto=format&fit=crop',
  rating: 4.9,
  students: 3200,
  duration: '12 weeks',
}
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-primary mb-2">$159</div>
