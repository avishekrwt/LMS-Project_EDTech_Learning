  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-96 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 to-green-700 opacity-90"></div>
        <img
          src={course.image}
          alt={course.title}
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li>• Building a Complete Marketing Plan</li>
                </ul>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-primary mb-2">$139</div>
