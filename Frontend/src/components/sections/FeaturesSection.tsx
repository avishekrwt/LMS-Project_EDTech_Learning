...
import { Book, Users, ChartBar, Globe } from "lucide-react";
...
export default function FeaturesSection() {
  return (
    <section id="features" className="max-w-6xl mx-auto px-8 py-20 text-center">
      <h2 className="text-3xl font-bold mb-6">Core Features</h2>
      <p className="text-muted-foreground mb-12">
        Everything you need to manage a world-class learning platform.
      </p>
